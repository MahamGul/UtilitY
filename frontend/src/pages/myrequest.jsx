    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-500">Track and manage your ongoing service requests</p>
        </div>
      ...
      <div className="flex flex-col md:flex-row justify-between gap-4 mb-6">
        ...
        <div className="flex gap-2 flex-wrap">
          {["all", "pending", "accepted", "in-progress"].map((status) => (
            ...
            >
              {status === "all" ? "All Requests" : getStatusConfig(status).label}
            </button>
          ))}
        </div>
            ...
            >
              ...
              <div className="flex gap-4 text-sm text-gray-500 mb-4">
                <div className="flex items-center gap-1">
                  <DollarSign className="w-4 h-4" />{request.budget}
                </div>
                <div className="flex items-center gap-1">
                  <Clock className="w-4 h-4" />{request.datePosted}
                </div>
              </div>
              ...
              {request.provider && (
                <div className="bg-gray-50 p-3 rounded-lg flex justify-between items-center mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <div>
                      <p className="text-sm font-semibold">{request.provider.name}</p>
                      <p className="text-xs text-yellow-500">★ {request.provider.rating}</p>
                    </div>
                  </div>
                ...
                {request.status === "pending" && (
                  <>
                    <button
                      ...
                      onClick={() => navigate("/customer-available-offers")}
                    >
